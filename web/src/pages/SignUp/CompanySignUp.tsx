  ...
  return (
    <div className="max-w-full min-h-screen flex flex-col items-center justify-center bg-[#f8f8f8]">
      <div className="w-full max-w-md space-y-8 mb-2 mt-4">
        <div>
          <h2 className="text-center text-3xl font-bold tracking-tight text-gray-900">Sign up and start to hire</h2>
        </div>
        <form className="mt-3 bg-white p-8 rounded-md w-full shadow-lg" onSubmit={handleRegister}>
          ...
          <div className="mt-3 mx-3">
            ...
            <div className="mt-1">
              <Textarea id="description" name="description" rows={3} placeholder="A brief description about your company" />
            </div>
          </div>
